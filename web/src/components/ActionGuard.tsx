...
/**
 * The one line a module page shows when every change it offers is refused:
 * the operator can read the module and learns what changing it would take,
 * instead of a page with its buttons quietly gone.
 */
