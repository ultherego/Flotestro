...
// handleListRelays lists the relays a host may be installed through.
//
// The list serves the installation: it is read with the right to prepare
// one, and narrowed to the sites the reader may prepare installations in.
// A relay without an environment serves its whole site, so a binding to
// any environment of the site sees it.
