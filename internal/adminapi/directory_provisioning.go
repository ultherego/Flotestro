...
// handleProvisionPreserveRights gives the connector's service account the one
// right a preserve needs and reports what it created, what was already there
// and what a directory administrator has to do.
func (s *Server) handleProvisionPreserveRights(w http.ResponseWriter, r *http.Request) {
	...
	// The directory's configuration changed, or was confirmed unchanged: either
	// way it belongs in the trail next to the other changes of who may do what.
