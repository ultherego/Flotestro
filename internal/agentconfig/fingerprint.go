...
// Fingerprint digests the effective configuration: what the agent runs on once
// the defaults filled in what the file left out and the durations were read.
func (c Config) Fingerprint() string {
	...
	// A struct of strings, ints and a string slice always marshals; the error is
	// left unread rather than turned into a fingerprint of nothing.
...
// reports it to the panel: the schema of the file on disk and the fingerprint
...
// Current returns the configuration file this process loaded.
